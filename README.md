...
1. **先将本仓库改为 Public**：点击 [此链接](../../settings#danger-zone) 直达 Danger Zone，或手动前往 **Settings → General → Danger Zone**，选择 **Change repository visibility → Public**
...
1. **Make this repository Public first**: click [this link](../../settings#danger-zone) to jump directly to Danger Zone, or manually go to **Settings → General → Danger Zone**, then select **Change repository visibility → Public**
